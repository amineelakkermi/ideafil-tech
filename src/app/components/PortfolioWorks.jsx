...
const PortfolioWorks = () => {
  ...
  return (
    ...
    >
      <div dir="rtl" className={`${styles.container} mx-auto grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12`}>
      ...
      <div className="flex justify-center">
        <Link 
          href="/works"
          className="group inline-flex items-center gap-3 px-8 py-4 rounded-full text-white font-tajwal font-bold text-lg
